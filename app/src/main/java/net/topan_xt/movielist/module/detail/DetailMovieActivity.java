...
public class DetailMovieActivity extends AppCompatActivity {
    ...
    @BindView(R.id.text_detail_movie_genre) TextView mTextGenre;
    @BindView(R.id.text_detail_movie_language) TextView mTextSubtitle;
    @BindView(R.id.text_detail_rating) TextView mTextRating;
